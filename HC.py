...
@st.cache_resource
def load_objects():
    model = joblib.load(os.path.join(BASE_DIR, "hierarchical_model.pkl"))
...
if os.path.exists(DATA_PATH):
    ...
    st.warning("⚠️ CSV not found. Loading Iris dataset from sklearn.")
...
if st.button("Predict Cluster"):
    ...
    st.metric("Species Encoded", species_encoded)
